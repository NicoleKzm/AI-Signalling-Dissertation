...
fresh_sample_out.to_csv("data/fresh_kappa_sample_v2.csv", index=False)
print(f"\nFresh sample saved to data/fresh_kappa_sample_v2.csv with {len(fresh_sample_out)} passages")
