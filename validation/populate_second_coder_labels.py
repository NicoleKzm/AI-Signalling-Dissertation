...
sample_df = pd.read_csv('data/second_coder_sample.csv')
main_df = pd.read_csv('data/all_classifications.csv')
...
sample_df[out_cols].to_csv('data/second_coder_sample.csv', index=False)
