...
ax.legend()
fig.tight_layout()
fig.savefig("figures/signal_score_distribution.png", dpi=150)
plt.close(fig)
...
fig.tight_layout()
fig.savefig("figures/signal_trend_by_year.png", dpi=150)
plt.close(fig)
print("    Saved figures/signal_trend_by_year.png\n")
