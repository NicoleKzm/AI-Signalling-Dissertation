...
full_panel = pd.read_csv("panel_dataset.csv")
...
ssi = pd.read_csv("small_sample_inference.csv")
...
out.to_csv("chapter4_gaps.csv", index=False)
print(f"\nchapter4_gaps.csv saved -- {len(out)} rows")
