...
class_df = pd.read_csv('all_classifications.csv')
...
baseline = pd.read_csv('signalling_scores.csv')  # authoritative list of all 69 firm-years
...
# ══════════════════════════════════════════════════════════════════
full_baseline = pd.read_csv('signalling_scores.csv')
...
summary_df.to_csv('fragmentation_robustness.csv', index=False)
print(f"\nfragmentation_robustness.csv saved -- {len(summary_df)} rows")
print("\nDone.")
