...
# Load both datasets
signalling = pd.read_csv('signalling_scores.csv')
financial = pd.read_csv('final_dataset.csv')
...
# Save
merged.to_csv('panel_dataset.csv', index=False)
print("\nDone — panel_dataset.csv saved")
